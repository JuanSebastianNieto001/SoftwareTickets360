...
export function IconTag({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.568 3H5.25A2.25 2.25 0 0 0 3 5.25v4.318c0 .597.237 1.169.659 1.591l9.581 9.581a2.25 2.25 0 0 0 3.182 0l4.318-4.318a2.25 2.25 0 0 0 0-3.182L11.16 3.66A2.25 2.25 0 0 0 9.568 3Z" />
...
export function IconFlag({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 3v18M3 4.5s1.5-1.5 4.5-1.5 4.5 1.5 7.5 1.5S21 3 21 3v10.5s-1.5 1.5-4.5 1.5-4.5-1.5-7.5-1.5S3 15 3 15" />
    </svg>
  );
}
...
export function IconMessage({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 0 1-2.555-.337A5.972 5.972 0 0 1 5.41 20.97a5.969 5.969 0 0 1-.474-.065 4.48 4.48 0 0 0 .978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25Z" />
    </svg>
  );
}
...
export function IconHandHeart({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 15h2.25a2.25 2.25 0 0 1 2.25 2.25v.375a.375.375 0 0 1-.375.375H8.25m0-3h9m-9 0a2.25 2.25 0 0 0-2.25 2.25v.375c0 .621.504 1.125 1.125 1.125H15m0 0a2.625 2.625 0 0 0 2.625-2.625V9.75M15 15v-4.5M4.5 12l3-3 3 3m9-1.5-3-3-3 3" />
    </svg>
  );
}
...
export function IconShield({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M12 3c-2.343 1.79-5.174 2.732-8.075 2.678A11.947 11.947 0 0 0 3 9.75c0 5.19 3.313 9.611 7.938 11.25A11.94 11.94 0 0 0 12 21.25a11.94 11.94 0 0 0 1.062-.25C17.687 19.361 21 14.94 21 9.75c0-.06 0-.12-.002-.18a11.947 11.947 0 0 1-8.923-6.57Z" />
    </svg>
  );
}
